    ...
    <!--<div id="layoutSidenav_content">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4">회원 강제 탈퇴</h1>
                        <ol class="breadcrumb mb-4">
                            <div></div>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                KH 아파트 ON 커뮤니티에 현재 가입한 회원을 강제로 탈퇴시킬 수 있습니다.
                                <br>
                                탈퇴 회원의 이름, 동-호수, 이메일, 전화번호를 입력하시면 확인 후
                                강제 탈퇴 페이지로 이동합니다.
                                <br>
                                <hr>
                                <b>탈퇴시킬 회원의 정보가 정확하지 않다면 하단의 검색창을 통해 검색 후 진행 가능합니다.
                                </b>
                            </div>
                        </div>
                        <hr>
