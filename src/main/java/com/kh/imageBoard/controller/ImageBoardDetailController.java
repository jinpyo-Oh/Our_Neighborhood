 ...
 */
@WebServlet("/imageDetail.bo")
public class ImageBoardDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ImageBoardDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			request.getRequestDispatcher("views/imageBoard/imageDetailView.jsp").forward(request, response);
