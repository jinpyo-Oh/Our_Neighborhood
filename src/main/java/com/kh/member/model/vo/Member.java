...
public class Member {
	...
	public Member(int memberNo, String memberId, String memberPwd, String memberName, String address, int address2, String email,
	...
	// 회원 가입용 생성자
	public Member(String memberId, String memberPwd, String memberName, String address, int address2, String email, String phone) {
		super();
		this.memberId = memberId;
		this.memberPwd = memberPwd;
		this.memberName = memberName;
	...
	public String toString() {
		return "Member [memberNo=" + memberNo + ", memberId=" + memberId + ", memberPwd=" + memberPwd + ", memberName="
				+ memberName + ", address=" + address + ", address2=" + address2 + ", email=" + email + ", phone=" + phone + ", status=" + status
				+ "]";
	}	
}
